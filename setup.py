...
plugin_identifier = "autopark"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_autopark"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-AutoPark"
...
# module
plugin_description = (
    """Park the print head at a specific location when pausing a print."""
)
...
plugin_url = "https://github.com/kForth/OctoPrint-AutoPark"
